...
#[test]
fn test_wycheproof() {
	wycheproof_runner("./tests/test_data/original/wycheproof_chacha20_poly1305_test.json", true);
	wycheproof_runner("./tests/test_data/original/wycheproof_xchacha20_poly1305_test.json", false);
}
